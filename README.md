...
[![Version](https://img.shields.io/badge/Version-3.0-00ff00?style=for-the-badge)](https://github.com/L3gitFoxy/3x3_timer)
...
### v3.0 (Current)
- **Quality tooling** — pytest, ruff, mypy, pre-commit hooks, GitHub Actions CI
- **Test suite** — 65 tests covering timer, scramble, and storage modules
- **Onboarding** — run.bat/run.sh one-click launchers, first-run welcome dialog
- **Modern Python** — migrated to `dict`/`list` syntax, Path.open(), top-level imports
